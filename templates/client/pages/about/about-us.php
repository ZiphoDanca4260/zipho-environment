...
<section class="boxcar-banner-section-v1 alt">
    <div class="container">
        <div class="banner-content">
            <span class="wow fadeInUp">At Primo, excellence is common and happiness is guaranteed.</span>
            <h2 class="wow fadeInUp" data-wow-delay="100ms">About Us</h2>
        </div>
    </div>
</section>
<!-- BANNER SECTION END -->
...
<section class="about-inner-one layout-radius">
    <div class="upper-box">
        <div class="boxcar-container">
            <div class="row wow fadeInUp">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="boxcar-title">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                            <div class="text">
                                Our inventory is vast and selectively chosen, showcased in our premier Edenvale showroom.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="content-box">
                        <div class="text">
                            At Primo Executive Cars, we take the hassle out of buying a pre-owned vehicle.
                            With branches currently in Edenvale and Boksburg,
                            we understand that a car is one of the most expensive items you will ever buy and so pride
                            ourselves on ensuring excellent service both before as well as post-sales.
                            Our extensive stable of personally selected premium vehicles is sure to impress even the most discerning buyer.
                        </div>
                        <div class="text">
                            At any given time, we have Over 200 vehicles on offer and should we not currently
                            stock your particular requirement, we confidently will endeavour to source it on your behalf.
                            Each of our specially trained business managers will ensure that you are provided with sound
                            financial and affordability advice and further tend to financing, insuring and licencing your purchase.
                        </div>
                        <div class="text">
                            Our exemplary service facilitates the entire transaction including in-house financing.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-5 wow fadeInLeft text-center">
                <h4>
                    We are proud to boast affiliation with all the major banks:
                </h4>
            </div>

            <div class="affiliated-banks wow fadeInUp row align-items-center">

                <div>
                    <div class="affiliated-bank position-relative">
                        <img class="img-fluid p-3 position-relative" src="/assets/default/image/banks-logos/absa-logo.png" alt="Absa">
                        <img class="ambient-light img-fluid p-3 position-absolute" src="/assets/default/image/banks-logos/absa-logo.png" alt="Absa">
                    </div>
                </div>

                <div>
                    <div class="affiliated-bank position-relative">
                        <img class="img-fluid p-3 position-relative" src="/assets/default/image/banks-logos/ned-logo.png" alt="Ned Bank">
                        <img class="ambient-light img-fluid p-3 position-absolute" src="/assets/default/image/banks-logos/ned-logo.png" alt="Ned Bank">
                    </div>
                </div>

                <div>
                    <div class="affiliated-bank position-relative">
                        <img class="img-fluid p-3 position-relative" src="/assets/default/image/banks-logos/standard-bank-logo.png" alt="Standard Bank">
                        <img class="ambient-light img-fluid p-3 position-absolute" src="/assets/default/image/banks-logos/standard-bank-logo.png" alt="Standard Bank">
                    </div>
                </div>

                <div>
                    <div class="affiliated-bank position-relative">
                        <img class="img-fluid p-3 position-relative" src="/assets/default/image/banks-logos/westbank-logo.png" alt="Westbank">
                        <img class="ambient-light img-fluid p-3 position-absolute" src="/assets/default/image/banks-logos/westbank-logo.png" alt="Westbank">
                    </div>
                </div>

                <div>
                    <div class="affiliated-bank position-relative">
                        <img class="img-fluid p-3 position-relative" src="/assets/default/image/banks-logos/bmw-logo.png" alt="BMW">
                        <img class="ambient-light img-fluid p-3 position-absolute" src="/assets/default/image/banks-logos/bmw-logo.png" alt="BMW">
                    </div>
                </div>

                <div>
                    <div class="affiliated-bank position-relative">
                        <img class="img-fluid p-3 position-relative" src="/assets/default/image/banks-logos/sa-motor-loans-logo.png" alt="SA Motor Loans">
                        <img class="ambient-light img-fluid p-3 position-absolute" src="/assets/default/image/banks-logos/sa-motor-loans-logo.png" alt="SA Motor Loans">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="exp-block col-md-2 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="image-box">
                            <figure class="image"><img src="/assets/default/image/template-images/resource/about-inner1-1.jpg" alt=""></figure>
                        </div>
                    </div>
                </div>
                <div class="image-block style-center col-md-5 col-sm-12">
                    <div class="image-box">
                        <figure class="image"><img src="/assets/default/image/template-images/resource/about-inner1-2.jpg" alt=""></figure>
                    </div>
                </div>
                <div class="image-block col-md-5 col-sm-12">
                    <div class="image-box two">
                        <figure class="image"><img src="/assets/default/image/template-images/resource/about-inner1-3.jpg" alt=""></figure>
                    </div>
                    <div class="row box-double-img">
                        <div class="image-block col-lg-5 col-5">
                            <div class="image-box">
                                <figure class="image"><img src="/assets/default/image/template-images/resource/about-inner1-4.jpg" alt=""></figure>
                            </div>
                        </div>
                        <div class="image-block col-lg-7 col-7">
                            <div class="image-box">
                                <figure class="image"><img src="/assets/default/image/template-images/resource/about-inner1-5.jpg" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-0">
                ...
                <div class="image-column col-lg-6 col-md-6 col-sm-12">
                    <div class="inner-column">
                        <div class="image-box">
                            <figure class="image"><a href="#"><img src="/assets/default/image/template-images/resource/pricing1-1.jpg" alt=""></a></figure>
